...
from dpo_shared_state import get_shared_state
    ...
    async def action(
        ...
        try:
            ...
            if shared_state.has_complete_pair(chat_id):
                ...
                self._log(f"Stored accepted response for chat {chat_id}, waiting for rejected")
                return "✅ Response marked as ACCEPTED! Now use the ❌ Reject Response button on another response to complete the preference pair."
